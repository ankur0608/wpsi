      ...
      <aside className={`fixed inset-y-0 left-0 w-[280px] bg-white border-r border-dark-100 z-50 transform lg:static transition-transform duration-300 ease-in-out flex flex-col shadow-2xl lg:shadow-none ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 hide-scrollbar relative z-10">
            ...
            <nav className="space-y-1">
                ...
                <Link href="/daily-practice" onClick={onClose} className={`sidebar-item ${isActive('/daily-practice') ? 'active' : ''} hover:bg-dark-50 font-medium flex items-center px-4 py-3 text-sm rounded-xl group transition-all`}>
                    <svg className="w-5 h-5 mr-3 group-hover:text-dark-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    Daily Practice
                </Link>
                {/* 
