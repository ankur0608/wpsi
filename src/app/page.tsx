...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Countdown Timer logic (Fake timer for FOMO)
    const timerElements = document.querySelectorAll('.countdown-timer');
    if (timerElements.length > 0) {
        let time = 2 * 3600 + 15 * 60 + 21; // 02:15:21
  ...
  return (
    ...
    {/*  Sticky Navbar  */}
    <nav className="fixed w-full z-50 glass border-b border-white/5 transition-all-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
                ...
                <div className="flex-shrink-0 flex items-center gap-2 cursor-pointer" onClick={() => window.location.href="/" }>
                    ...
                    <span className="font-heading font-bold text-2xl tracking-tight">Exam<span className="text-brand-500">Pro</span></span>
                </div>
                ...
                <div className="md:hidden flex items-center">
                    <button id="mobile-menu-btn" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="text-slate-300 hover:text-white focus:outline-none">
        ...
        {/*  Mobile Menu  */}
        <div id="mobile-menu" className={`${mobileMenuOpen ? "block" : "hidden"} md:hidden glass-card absolute w-full border-b border-white/10`}>
    ...
    <section id="features" className="py-20 bg-dark-card border-y border-white/5 relative overflow-hidden">
        {/*  Abstract shape  */}
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-brand-500/10 to-secondary/10 rounded-full blur-3xl"></div>
                    ...
                    <div className="glass-card rounded-2xl p-6 border border-white/10 shadow-2xl relative z-10">
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                <img src="https://ui-avatars.com/api/?name=User&background=6366f1&color=fff" alt="User" className="w-12 h-12 rounded-full border-2 border-brand-500" />
                                <div>
