        ...
        <div className="relative z-10">
          ...
          {/* <div className="flex flex-col gap-3 text-left">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/5 text-center">
              <div className="text-[9px] font-black text-slate-500 uppercase mb-1">Current Streak</div>
        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10">
            <div className="flex items-center gap-5">
              ...
              <div>
                <h3 className="text-3xl font-heading font-black text-white">Share WPSI</h3>
                <p className="text-sm text-slate-400 mt-1">Help your friends prepare for the exam by sharing WPSI.</p>
              </div>
            </div>
          </div>

          <div className="mt-8 flex justify-start">
              <button onClick={() => window.open(`https://wa.me/?text=WPSI%20exam%20is%20on%2021%20June.%20I%27m%20preparing%20on%20WPSIPro%20%E2%80%94%201800%2B%20MCQs%2C%20Part%20A%20%2B%20Part%20B%20%2B%20Mock%20Tests.%20Join%20with%20my%20link%3A%20wpsipro.com/join/${user?.name?.replace(/\s+/g, '').toLowerCase() || 'user'}`)} className="bg-[#25D366] text-white font-black text-sm uppercase tracking-widest rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-xl shadow-[#25D366]/20 px-8 py-4 w-full md:w-auto">
