...
{/* <div className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-6 lg:p-8" style={{"background":"radial-gradient(circle at 50% -20%, rgba(99,102,241,0.15), transparent 70%), radial-gradient(circle at 100% 100%, rgba(245,158,11,0.05), transparent 40%)"}}>
    <div className="max-w-6xl mx-auto pb-24 space-y-12">
        ...
        <div className="group py-12 px-8 sm:px-12 rounded-[2.5rem] relative overflow-hidden transition-all duration-500 border border-[var(--border-subtle)] shadow-2xl" style={{"background":"linear-gradient(145deg, #141D2E, #0D1120)"}}>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6">
                        ...
                        <div>
                            <div className="flex items-baseline gap-2 justify-center lg:justify-start">
                                <span className="text-7xl font-black text-[var(--text-primary)] font-mono tracking-tighter">2,450</span>
                ...
                <div className="w-full lg:w-[26rem] bg-white/5 backdrop-blur-xl p-8 rounded-[2rem] border border-[var(--border-subtle)] relative overflow-hidden group/card">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-500/10 blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                    <div className="flex justify-between items-end mb-4 relative z-10">
                        <div className="text-[11px] font-black text-[var(--text-muted)] uppercase tracking-widest">Goal: Silver Tier</div>
                    ...
                    <div className="space-y-4 relative z-10">
                        <p className="text-xs text-[var(--text-muted)] leading-relaxed font-medium">Earn <span className="text-[var(--text-primary)] font-bold">550 more coins</span> to unlock <span className="text-cyan-400 font-black">1.2x Coin Multiplier</span> & <span className="text-cyan-400 font-black">10% Purchase Discount</span>.</p>
        ...
        <section className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="rounded-3xl p-8 bg-white/5 border border-[var(--border-subtle)] relative group/tier overflow-hidden transition-all hover:border-cyan-500/30">
                    <div className="relative z-10">
                ...
                <div className="rounded-3xl p-8 bg-white/5 border border-[var(--border-subtle)] relative group/tier overflow-hidden transition-all hover:border-warning/30">
                    <div className="relative z-10">
                ...
                <div className="rounded-3xl p-8 bg-white/5 border border-[var(--border-subtle)] relative group/tier overflow-hidden transition-all hover:border-brand-500/30">
        ...
        <section className="space-y-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                ...
                <div className="flex p-1 bg-white/5 rounded-2xl border border-[var(--border-subtle)]">
                    <button className="px-6 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest bg-brand-500 text-[var(--text-primary)] shadow-xl">Redeem Tools</button>
                    <button className="px-6 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors">My Wallet</button>
                </div>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="rounded-3xl p-6 bg-dark-card/40 border border-[var(--border-subtle)] group hover:border-warning/40 transition-all">
                ...
                <div className="rounded-3xl p-6 bg-dark-card/40 border border-[var(--border-subtle)] group hover:border-brand-500/40 transition-all">
                    ...
                    <button className="w-full py-3.5 rounded-2xl bg-brand-500/10 border border-brand-500/20 text-brand-400 font-black text-[10px] uppercase tracking-widest transition-all hover:bg-brand-500 hover:text-[var(--text-primary)]">Redeem 100 🪙</button>
                </div>

                <div className="rounded-3xl p-6 bg-dark-card/40 border border-[var(--border-subtle)] group hover:border-cyan-500/40 transition-all">
                ...
                <div className="rounded-3xl p-6 bg-dark-card/40 border border-[var(--border-subtle)] group hover:border-accent/40 transition-all">
        ...
        <section className="rounded-[2.5rem] p-10 bg-dark-card border border-[var(--border-subtle)] relative overflow-hidden group/earn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-[var(--border-subtle)]">
