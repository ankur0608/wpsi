        ...
        <div className="glass p-10 rounded-[3rem] relative overflow-hidden">
            ...
            <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4 text-left p-4 rounded-2xl bg-white/5 border border-[var(--border-subtle)]">
                    ...
                    <div>
                        <div className="text-sm font-bold text-[var(--text-primary)]">₹30 Flat Discount</div>
                        <p className="text-[10px] text-[var(--text-muted)]">Auto-applied on your first purchase.</p>
                    </div>
                </div>
                <div className="flex items-start gap-4 text-left p-4 rounded-2xl bg-white/5 border border-[var(--border-subtle)]">
                ...
                <div className="flex items-start gap-4 text-left p-4 rounded-2xl bg-white/5 border border-[var(--border-subtle)]">
                    ...
                    <div>
                        <div className="text-sm font-bold text-[var(--text-primary)]">2 Free Chapters</div>
                        <p className="text-[10px] text-[var(--text-muted)]">Double the standard trial content.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-10 p-4 rounded-2xl bg-danger/10 border border-danger/20 text-center">
                ...
                <div className="text-lg font-black text-[var(--text-primary)]">June 21 — 35 Days Left</div>
            </div>

            <a href="/register" className="block w-full py-5 bg-brand-500 text-[var(--text-primary)] font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl shadow-brand-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all">Claim Rewards & Sign Up Free</a>
        </div>

        <p className="text-[10px] text-[var(--text-muted)] font-medium">Already have an account? <a href="/login" className="text-brand-400 font-bold hover:underline">Log in here</a></p>
    </div>
