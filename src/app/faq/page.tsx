...
export const metadata: Metadata = {
  ...
  description: 'Find answers to common questions about ExamPro, including details about our government exam mock tests, pricing plans, syllabus coverage for Wireless PSI and GPSC, and platform features.',
};
    ...
    <div className="relative w-full overflow-x-hidden bg-[#0D1B2A] text-[#F2ECD9]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <p className="text-center text-slate-400 mb-12 max-w-2xl mx-auto">
          Everything you need to know about ExamPro's mock tests, study materials, and platform features for Gujarat Government exams.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6 rounded-2xl border border-white/5">
            ...
            <p className="text-slate-300 leading-relaxed">
              Absolutely! ExamPro is fully responsive and optimized for mobile devices. You can practice MCQs, check your stats, and take full-length mock tests on any smartphone or tablet directly through your web browser.
            </p>
          </div>
