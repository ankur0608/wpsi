...
export default function FAQPage() {
  return (
    <div className="relative w-full min-h-screen overflow-x-hidden bg-primary-bg text-primary-text">
      <LandingNavbar />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <p className="text-center text-secondary-text mb-12 max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6 rounded-2xl border border-[var(--border-subtle)]">
            <h3 className="text-xl font-bold mb-3 text-primary-text">Are the mock tests based on the latest syllabus?</h3>
            <p className="text-secondary-text leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-[var(--border-subtle)]">
            <h3 className="text-xl font-bold mb-3 text-primary-text">Can I access the platform on my mobile phone?</h3>
            <p className="text-secondary-text leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-[var(--border-subtle)]">
            <h3 className="text-xl font-bold mb-3 text-primary-text">How does the AI Study Planner work?</h3>
            <p className="text-secondary-text leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-[var(--border-subtle)]">
            <h3 className="text-xl font-bold mb-3 text-primary-text">What is the refund policy for premium plans?</h3>
            <p className="text-secondary-text leading-relaxed">
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, our subject matter experts regularly update the mock tests and MCQ database to strictly adhere to the latest syllabi and exam patterns announced by the respective exam boards (like GSSSB and GPSC)."
                }
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "We offer a 3-day money-back guarantee for our Pro and Elite plans if you are unsatisfied with the content. Please refer to our Terms and Conditions for detailed information regarding refunds and subscription cancellations."
                }
              }
            ]
          })
